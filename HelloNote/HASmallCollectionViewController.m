...
- (void)viewDidLoad
{
    ...
    // ImageView on top
    _topImage = [[UIImageView alloc] initWithFrame:self.view.frame];
    _reflected = [[UIImageView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(_topImage.bounds), CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame))];
